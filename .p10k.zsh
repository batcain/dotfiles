# Generated by Powerlevel10k configuration wizard on 2021-01-15 at 21:15 +03.
...
() {
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=208
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=236
  # Custom icon.
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=202
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=214
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=237
  typeset -g POWERLEVEL9K_IP_FOREGROUND=222
